		...
		<section className='help'>
			<div className='container-main mt-3 p-3'>
                ...
                <h4>Generar propuestas de matrícula para otorgamiento masivo</h4>
									<p className='timeline-subtitle'>
										Para ver las propuestas de nuevas matrículas para la etapa de otorgamiento masivo puede encontrar un botón abajo a la derecha del listado general. 
                    Generará las propuestas y activará una nueva pantalla en la que se mostrarán en un listado. Puede accceder a esta pantalla en el nuevo ícono <i className="bi bi-ui-checks"></i> 
									</p>
								</div>
							</div>
              <div className='col-lg-6'>
          ...
          <div className='timeline-item'>
                ...
                <h4>Aprobar propuestas de matrícula para otorgamiento masivo</h4>
									<p className='timeline-subtitle'>
										Para aprobar las propuestas de nuevas matrículas generadas diríjase a la nueva página donde se muestra el listado a través del ícono <i className="bi bi-ui-checks"></i> en la barra de navegación. Seleccione las que fueron aceptadas por la Comisión de Otrogamiento y presione el botón aceptar que econtrará abajo a la derecha. 
